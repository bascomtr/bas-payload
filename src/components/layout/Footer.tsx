...
export function Footer({ locale, navigation, siteSettings, dict }: FooterProps) {
      ...
      <div className="container">
        ...
        <div className="footer-grid">
          ...
          <div className="footer-brand">
            ...
            <Link href={getLocalePath(locale)} className="footer-logo">
              <Image
                src="/bas_logo.svg"
            ...
            {siteSettings?.social && (
              <div className="footer-social">
                {siteSettings.social.facebook && (
                  <a href={siteSettings.social.facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="social-link">
                ...
                {siteSettings.social.linkedin && (
                  <a href={siteSettings.social.linkedin} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="social-link">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                {siteSettings.social.instagram && (
                  <a href={siteSettings.social.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="social-link">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                {siteSettings.social.youtube && (
                  <a href={siteSettings.social.youtube} target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="social-link">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div key={index} className="footer-column">
              ...
              <ul className="footer-links">
                {column.links?.map((link, linkIndex) => {
                  const href = link.type === 'internal' && link.internalLink
                    ? getInternalLink(link.internalLink, locale)
                    : link.externalLink || '#'
          ...
          <div className="footer-column">
            <h3 className="footer-heading">{dict.contact?.title || 'İletişim'}</h3>
        ...
        <div className="footer-bottom">
          <p>© {currentYear} {siteSettings?.companyName || 'BAS Endüstriyel'}. {dict.footer?.copyright || 'Tüm hakları saklıdır.'}</p>
          <div className="footer-bottom-links">
            <Link href={getLocalePath(locale, '/gizlilik-politikasi')}>{dict.footer?.privacy || 'Gizlilik Politikası'}</Link>
            <Link href={getLocalePath(locale, '/kvkk')}>KVKK</Link>
          </div>
        </div>
      </div>
    </footer>
